...
- 人們對於區塊鍊的支持並非因其功能上有所突破
  - 分散式帳本起初已是來自**政治性動機**的選擇
  - 必須先釐清現今的討論，已將**對其非功能需求部分的支持**（權力下放、持續營運、匿名使用…），以及從投機性資金導致的**對利益的期待**混為一談
...
以及「具唯一性的可持有資產」與數位特性的衝突，並未因為 NFT 的登場有所改善。現今反而充斥以投機資金為目標的詐欺商法，若未做好功課便貿然出手會有較高的風險。
...
若要承襲此精神，試圖邁向更好的區塊鍊與 NFT 的活用，可說是必須要以製作者，而非使用者的身分去參與其中。
