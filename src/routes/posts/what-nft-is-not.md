...
- 「區塊鍊」是構成加密資產的分散式帳本機制，由所有人共同記帳
  - 成立於礦工解出極困難的數學題以檢驗交易內容（Proof-of-Work）
...
- 區塊鍊的本質在**非功能需求**的部分
  - 去中央集權性（decentralization）：不受特定國家或企業支配
  - 持續性（continuity）：某一主體無法繼續提供服務後仍能有承接者
  - 匿名性（anonymity）：將個人與交易紀錄分離
- 為了防止非中央集權式的方法導致重複支付，需要使用加密技術
  - 加密技術的角色不只是為了保密資訊，也包含防止竄改資訊
- 「Timestamp」是比特幣的起源想法之一
  - 經由採取可信賴的第三者發出的時間認證（timestamp），證明當時曾經發生過電子交易
...
- 人們對於區塊鍊的支持並非因其功能上有所突破
  ...
  - 必須先釐清現今的討論，已將**對其非功能需求部分的支持**（去中央集權性、持續性、匿名性…），以及從投機性資金導致的**對利益的期待**混為一談
  - 尤其虛擬貨幣的高漲是起於某國富裕階級的資本外逃這點頗具象徵性
...
- 常見的誤解：區塊鍊上紀錄的**並不是**獨一無二的 NFT 藝術作品
  ...
  - ※ 雖然能將作品資料放進 NFT 上鍊，隨資料量增加亦會使手續費大幅提高
...
若要承襲此精神，試圖邁向更好的區塊練與 NFT 的活用，可以說是必須要以製作者，而非使用者的身分去參與其中。
