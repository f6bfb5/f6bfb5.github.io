...
- [現代 JS 的常見基礎技術](#現代-js-的常見基礎技術)
- [撰寫](#撰寫)
  - [變數](#變數)
  - [宣告](#宣告)
  - [命名](#命名)
- [型別](#型別)
  - [`typeof` 運算子](#typeof-運算子)
- [非同步處理](#非同步處理)
  - [Callback](#callback)
  - [Promises](#promises)
...
- [AJAX](#ajax)
  ...
  - [3. Fetch](#3-fetch)
  - [4. Axios](#4-axios)
- [ES6 加進的新功能](#es6-加進的新功能)
  - [1. Default Parameters](#1-default-parameters)
  - [2. Template Literals](#2-template-literals)
  - [3. Multi-line Strings](#3-multi-line-strings)
  - [4. Destructing Assignment](#4-destructing-assignment)
  - [5. Object Literals](#5-object-literals)
  - [6. Arrow Function](#6-arrow-function)
  - [7. Promise](#7-promise)
  - [8. Let & Const, Block-Scoped](#8-let--const-block-scoped)
  - [9. Classes](#9-classes)
  - [10. Module](#10-module)
...
- [IntersectionObserver](#intersectionobserver)
  ...
  - [使用](#使用-1)
- [進階](#進階)
  - [What's THIS in JavaScript ?](#whats-this-in-javascript-)
  - [Closure](#closure)
  - [Hoisting](#hoisting)
