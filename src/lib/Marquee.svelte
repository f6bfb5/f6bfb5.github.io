<script>
  const sentencesToShow = [
    ...
    "言語は思考を規定する",
    "このような運動を起こすとき、起こした最初の人、つまりリーダーがいつも過大評価される傾向にあります。しかし、お気づきのように、より評価されるべきは2人目のフォロワーなのです。 2人目がいなければ、1人目はただの「変な人」で終わってしまうかもしれません。 そこで、デレク・シヴァーズはこう言います。「本当に運動を起こそうと思うなら、リーダーについて行く勇気を持ち、他の人達にも その方法を示すことです。素晴らしいことをしている孤独なバカを見つけたら、立ち上がって参加する、最初の人間となる勇気を持ってください」と。",
