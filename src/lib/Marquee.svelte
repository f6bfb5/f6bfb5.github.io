<script>
  const sentencesToShow = [
    ...
    // "「クロスゲート」「なつみステップ」「num1000」「DoRaeMooooooooooooN!!!!」「ポケモンイエロー」「ポケモンシルバー」「ロックマンワールド」「チョコボレーシング」「クロノクロス」「レジェンドオブマナ」「三国無双2」「スパロボZ」「スマブラX」「モンスターハンターP2G」「SEED」「ファースト」「Z」「ZZ」「逆シャア」「F91」「V」「ターンA」「らき☆すた」「鋼の錬金術師」「AIR」「ToHeart2」「Fate/stay night」「瀬戸の花嫁」「エウレカ」「かみちゅ！」「BLOOD+」「攻殻機動隊 STAND ALONE COMPLEX」「東のエデン」「東京マグニチュード8.0」「Blacker Thank Black」「電脳コイル」「ぼくらの」「天元突破グレンラガン」「BLASSREITER」「海月姫」「ちはやふる」「カリオストロの城」「パーフェクトブルー」「パプリカ」「ブレンパワード」「オネアミスの翼」「On Your Mark」「フリクリ」「ホーリーマウンテン」「2001年宇宙の旅」「時計じかけのオレンジ」「ゴッドファーザー」「十二人の怒れる男」「ファイトクラブ」「思い出はおっくせんまん」「友人マリオ」「イチローのレーザービームで人類滅亡」「最終鬼畜ゲームを実況プレイ」「忙しい人向けシリーズ」「ゆめにっき」「MOTHER」「さようならを教えて」「終ノ空」「狂った果実」「リンダーキューブ」「街」「プラネテス」「ハチミツとクローバー」「世界の終わりと夜明け前」「ヨコハマ買い出し紀行」「げんしけん」「スラムダンク」「鋼の錬金術師」「海街ダイアリー」「クロスゲーム」「最終兵器彼女」",
