...
export const marqueeTexts = readable([
  ...
  "理想だと！？戯れ言だ！",
  "――忘れるな。イメージするのもは常に最強の自分だ。外敵など要らぬ。おまえにとって戦う相手とは、自分のイメージに他ならない",
  ...
  "12 　タチコマの家出 映畫監督の夢　 ESCAPE FROM「我當然不會說那是個糟糕的電影，不過，基本上無論什麼娛樂都只是一時的，而且也應該如此，像這種沒有開始也沒有結束，只是一味迷住觀眾使其無法離開的電影，不管它是多了不起的東西，只是有害無益。」「哦，很嚴厲的批評呢，你是不是想說觀眾有自己應該回到的現實呢？」「是的。」「在這裡的觀眾中，也有人一回到現實就會遭到不幸，如果你把那些觀眾的夢想奪走，你承擔得起責任嗎？」「承擔不起啊。但正是在現實生活中拼搏，夢想才有意義，只是把自己投射到別人的夢想裡的話，跟死又有什麼兩樣。」「真是一個現實主義者啊。」「如果你把逃避現實叫做浪漫的話。」「好個堅強的女孩呢。什麼時候你堅信的現實建構完成了，再來叫我們吧。那時我們會從這個電影院裡出來的。」",
  "「巴特，你有沒有被電影情節感動而哭過的經歷呢？」「這麼說來以前有過啊，我在看馬克斯兄弟的電影的時候，因為笑得太厲害而流眼淚啊。」「真像你啊。」「對了，下次我們兩個去看場電影怎麼樣？」「謝謝啦，不過如果有真想去看的電影，我會選擇一個人去看。」「那相比之下不怎麼想看的電影呢？」「不看。」「原來如此。」",
  ...
  "得到幸福的兩個開關，一個是吃下好吃的食物、沈浸在自己的興趣裡⋯只要自己一人就能按下的開關，另一個是被他人稱讚、認同，不是由他人按下，就無法感受到幸福的開關。能由自己按下的開關，雖然得到的幸福是輕微而少量的，但能在自己想要的時候按下。由他人按下的幸福開關，所得到的幸福卻是強烈的，會希望他人能夠不斷按下、對此欲罷不能。反之則會覺得不滿和不安滿溢而出，失去自信。最後就會變得覺得，只要能讓他人按下開關，什麼都願意去做，舞台就是讓他人按下開關的所在。在上面會覺得，只要能受到歡迎什麼都會去做，即使是把自己的一切都出賣了，總之就是希望他人能夠按下開關。回過神來時，也許會發現失去了重要的東西。那⋯那麼該怎麼做，才能避免這樣的事情發生呢？要把呈現出去，和不呈現出去的東西分開來，呈現出去的是「技藝」，想繼續站在舞台上，就得去磨練自己的技藝。",
  ...
  "小心別讓快樂壞掉",
  // https://pettittechen.blogspot.com/2015/03/blog-post_31.html
  "我的意思是，我依然不喜歡那些我身為部落客時所寫過負評的任何一款遊戲，但是我已經不再是那個對它們充滿敵意的混蛋了。不要誤解我的意思：我仍然認為負面的評論對遊戲這個媒介來說是絕對重要的，但是將我不喜歡的遊戲批得體無完膚，只為了證明我在某方面比它的開發者們還要聰明，不再使我感到享受了。批評家大致上是照顧讀者為主，而非開發者ーー當我在Destructoid上給了曙光公主（Twilight Princess）4/10這樣的分數時，我試著警告人們別將錢花在上面的想法，比我想要拿刀捅任天堂的想法還要多。但在那樣的關聯之下，是很容易地忽略一個事實，那就是當你對開發者們開砲時，你打到的是真實存在的人類。是有生命、感情、熱情、以及（如果他們和我一樣的話）那事關重大的自尊。換句話說，我如果就算他媽的能和善一點的話也不會死掉。我並不是要說所有的評論家都是一些豬頭，以及所有的開發者們都不會犯錯ーー一點也沒有這樣的意思。評論家是他媽的必要的，然後開發者們會犯錯。但是在我身為部落客時，我以為我知道的，和遊戲開發的真相的鴻溝是如此地巨大，無可想像地浩大，讓我有時候想要回到20歳出頭的我的身邊把我搖醒。",
  // ----------------
